          ...
          <div className="contentContainer">
            ...
            <Route path="/bank/" render={() => 
              <MapGuide 
                ...
                floorStart={[1,4]}
                pictures={[
                  [require('./images/bank/B1_1.png'), require('./images/bank/B1_2.png')],
                  [require('./images/bank/1st1_1.png'), require('./images/bank/1st1_2.png')], 
                  [require('./images/bank/1st2_1.png'), require('./images/bank/1st2_2.png')], 
                  [require('./images/bank/1st3_1.png'), require('./images/bank/1st3_2.png')],
                  [require('./images/bank/2nd1_1.png'), require('./images/bank/2nd1_2.png')], 
                  [require('./images/bank/2nd2_1.png'), require('./images/bank/2nd2_2.png')]
                ]} 
                text={[
            ...
            <Route path="/kafe_dostoyevsky/" render={() =>
              <MapGuide
